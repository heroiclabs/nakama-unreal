...
namespace Nakama {
	...
	class NAKAMA_API NGroupUsersListMessage : public INCollatedMessage
	{
	private:
		Envelope envelope;
		NGroupUsersListMessage(std::string groupId);
	...
	public:
		...
		static NGroupUsersListMessage Default(std::string groupId);
	};
}
