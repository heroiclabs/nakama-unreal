...
namespace Nakama {
	...
	class NAKAMA_API NGroupRemoveMessage : public INCollatedMessage
	{
	private:
		Envelope envelope;
		NGroupRemoveMessage(std::string groupId);
	...
	public:
		...
		static NGroupRemoveMessage Default(std::string groupId);
	};
}
