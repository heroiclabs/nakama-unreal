...
namespace Nakama {
	...
	class NAKAMA_API NGroupKickUserMessage : public INCollatedMessage
	{
	private:
		Envelope envelope;
		NGroupKickUserMessage(std::string groupId, std::string userId);
	...
	public:
		...
		static NGroupKickUserMessage Default(std::string groupId, std::string userId);
	};
}
