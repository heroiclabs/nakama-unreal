...
namespace Nakama {
	...
	// OnSuccess returns: NResultSet<NTopic>*
	class NAKAMA_API NTopicJoinMessage : public INCollatedMessage
	{
	private:
		Envelope envelope;
		NTopicJoinMessage();
	...
	class NAKAMA_API NTopicJoinMessage::Builder
	{
	private:
		NTopicJoinMessage message;
