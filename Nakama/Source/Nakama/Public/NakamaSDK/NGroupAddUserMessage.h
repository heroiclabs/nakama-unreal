...
namespace Nakama {
	...
	class NAKAMA_API NGroupAddUserMessage : public INCollatedMessage
	{
	private:
		Envelope envelope;
		NGroupAddUserMessage(std::string groupId, std::string userId);
	...
	public:
		...
		static NGroupAddUserMessage Default(std::string groupId, std::string userId);
	};
}
