...
namespace Nakama {
	...
	class NAKAMA_API NGroupPromoteUserMessage : public INCollatedMessage
	{
	private:
		Envelope envelope;
		NGroupPromoteUserMessage(std::string groupId, std::string userId);
	...
	public:
		...
		static NGroupPromoteUserMessage Default(std::string groupId, std::string userId);
	};
}
