...
*/
USTRUCT(BlueprintType)
struct NAKAMA_API FNakamaFriendsOfFriendsListFriendOfFriend
{
  GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct NAKAMA_API FNakamaGroupUserListGroupUser
{
  GENERATED_BODY()
...
struct NAKAMA_API FNakamaLeaderboard
{
  ...
  ENakamaOperator Operator = ENakamaOperator(0);
...
*/
USTRUCT(BlueprintType)
struct NAKAMA_API FNakamaUserGroupListUserGroup
{
  GENERATED_BODY()
...
struct NAKAMA_API FNakamaValidatedPurchase
{
  ...
  ENakamaStoreProvider Store = ENakamaStoreProvider(0);
  ...
  ENakamaStoreEnvironment Environment = ENakamaStoreEnvironment(0);
...
*/
USTRUCT(BlueprintType)
struct NAKAMA_API FNakamaWriteLeaderboardRecordRequestLeaderboardRecordWrite
{
  GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct NAKAMA_API FNakamaWriteTournamentRecordRequestTournamentRecordWrite
{
  GENERATED_BODY()
