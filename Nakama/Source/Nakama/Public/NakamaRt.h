...
namespace Nakama
{
    ...
    public:
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> Channel(
            const FString& Id,
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> ChannelJoin(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> ChannelLeave(
        ...
        * @param UserIdTwo  The ID of the second DM user, or an empty string if this message was not sent through a DM chat.
        */
        NAKAMA_API TFuture<FRealtimeResponse> ChannelMessage(
            const FString& ChannelId,
        ...
        * @param UserIdTwo  The ID of the second DM user, or an empty string if this message was not sent through a DM chat.
        */
        NAKAMA_API TFuture<FRealtimeResponse> ChannelMessageAck(
            const FString& ChannelId,
            const FString& MessageId,
            const int32& Code,
            const FString& Username,
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> ChannelMessageSend(
            const FString& ChannelId,
            const FString& Content
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> ChannelMessageUpdate(
            const FString& ChannelId,
            const FString& MessageId,
            const FString& Content
        ) noexcept;
        ...
        * @param MessageId  The ID assigned to the message to update.
        */
        NAKAMA_API TFuture<FRealtimeResponse> ChannelMessageRemove(
            const FString& ChannelId,
            const FString& MessageId
        ) noexcept;
        ...
        * @param UserIdTwo  The ID of the second DM user, or an empty string if this message was not sent through a DM chat.
        */
        NAKAMA_API TFuture<FRealtimeResponse> ChannelPresenceEvent(
            const FString& ChannelId,
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> Error(
            const int32& Code,
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> Match(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchCreate(
            const FString& Name
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchData(
            const FString& MatchId,
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchDataSend(
            const FString& MatchId,
            const int64& OpCode,
            const TArray<uint8>& Data,
            const TArray<FNakamaRtUserPresence>& Presences,
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchJoin(
        ...
        * @param MatchId  The match unique ID.
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchLeave(
            const FString& MatchId
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchPresenceEvent(
            const FString& MatchId,
            const TArray<FNakamaRtUserPresence>& Joins,
            const TArray<FNakamaRtUserPresence>& Leaves
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchmakerAdd(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchmakerMatched(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchmakerRemove(
            const FString& Ticket
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> MatchmakerTicket(
            const FString& Ticket
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> Notifications(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> Rpc(
            const FString& Id,
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> Status(
            const TArray<FNakamaRtUserPresence>& Presences
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> StatusFollow(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> StatusPresenceEvent(
            const TArray<FNakamaRtUserPresence>& Joins,
            const TArray<FNakamaRtUserPresence>& Leaves
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> StatusUnfollow(
            const TArray<FString>& UserIds
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> StatusUpdate(
        ...
        * @param Reliable  True if this data was delivered reliably, false otherwise.
        */
        NAKAMA_API TFuture<FRealtimeResponse> StreamData(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> StreamPresenceEvent(
            const FNakamaRtStream& Stream,
            const TArray<FNakamaRtUserPresence>& Joins,
            const TArray<FNakamaRtUserPresence>& Leaves
        ) noexcept;
        ...
        *
        */
        NAKAMA_API TFuture<FRealtimeResponse> Ping(
        ...
        *
        */
        NAKAMA_API TFuture<FRealtimeResponse> Pong(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> Party(
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyCreate(
            const bool& Open,
            const int32& MaxSize,
            const FString& Label,
            const bool& Hidden
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyJoin(
            const FString& PartyId
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyLeave(
            const FString& PartyId
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyPromote(
            const FString& PartyId,
            const FNakamaRtUserPresence& Presence
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyLeader(
            const FString& PartyId,
            const FNakamaRtUserPresence& Presence
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyAccept(
            const FString& PartyId,
            const FNakamaRtUserPresence& Presence
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyRemove(
            const FString& PartyId,
            const FNakamaRtUserPresence& Presence
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyClose(
            const FString& PartyId
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyJoinRequestList(
            const FString& PartyId
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyJoinRequest(
            const FString& PartyId,
            const TArray<FNakamaRtUserPresence>& Presences
        ) noexcept;
        ...
        * @param NumericProperties  Numeric properties.
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyMatchmakerAdd(
            const FString& PartyId,
            const int32& MinCount,
            const int32& MaxCount,
            const FString& Query,
        ...
        * @param Ticket  The ticket to cancel.
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyMatchmakerRemove(
            const FString& PartyId,
            const FString& Ticket
        ) noexcept;
        ...
        * @param Ticket  The ticket that can be used to cancel matchmaking.
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyMatchmakerTicket(
            const FString& PartyId,
            const FString& Ticket
        ) noexcept;
        ...
        * @param Data  Data payload, if any.
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyData(
            const FString& PartyId,
            const FNakamaRtUserPresence& Presence,
            const int64& OpCode,
            const TArray<uint8>& Data
        ...
        * @param Data  Data payload, if any.
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyDataSend(
            const FString& PartyId,
            const int64& OpCode,
            const TArray<uint8>& Data
        ) noexcept;
        ...
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyPresenceEvent(
            const FString& PartyId,
            const TArray<FNakamaRtUserPresence>& Joins,
            const TArray<FNakamaRtUserPresence>& Leaves
        ) noexcept;
        ...
        * @param Hidden  Whether the party is visible in party listings.
        */
        NAKAMA_API TFuture<FRealtimeResponse> PartyUpdate(
            const FString& PartyId,
            const FString& Label,
            const bool& Open,
            const bool& Hidden
