...
FNakamaAddFriendsRequest FNakamaAddFriendsRequest::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* IdsArrayPtr;
  if (Json->TryGetArrayField(TEXT("ids"), IdsArrayPtr))
  {
    for (const auto& Item : *IdsArrayPtr)
    {
      Result.Ids.Add(Item->AsString());
    }
  }
  const TArray<TSharedPtr<FJsonValue>>* UsernamesArrayPtr;
  if (Json->TryGetArrayField(TEXT("usernames"), UsernamesArrayPtr))
  {
    for (const auto& Item : *UsernamesArrayPtr)
    {
...
FNakamaAddGroupUsersRequest FNakamaAddGroupUsersRequest::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* UserIdsArrayPtr;
  if (Json->TryGetArrayField(TEXT("user_ids"), UserIdsArrayPtr))
  {
    for (const auto& Item : *UserIdsArrayPtr)
    {
...
FNakamaDeleteStorageObjectsRequest FNakamaDeleteStorageObjectsRequest::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* ObjectIdsArrayPtr;
  if (Json->TryGetArrayField(TEXT("object_ids"), ObjectIdsArrayPtr))
  {
    for (const auto& Item : *ObjectIdsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaFriendList FNakamaFriendList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* FriendsArrayPtr;
  if (Json->TryGetArrayField(TEXT("friends"), FriendsArrayPtr))
  {
    for (const auto& Item : *FriendsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaFriendsOfFriendsList FNakamaFriendsOfFriendsList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* FriendsOfFriendsArrayPtr;
  if (Json->TryGetArrayField(TEXT("friends_of_friends"), FriendsOfFriendsArrayPtr))
  {
    for (const auto& Item : *FriendsOfFriendsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaGetUsersRequest FNakamaGetUsersRequest::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* FacebookIdsArrayPtr;
  if (Json->TryGetArrayField(TEXT("facebook_ids"), FacebookIdsArrayPtr))
  {
    for (const auto& Item : *FacebookIdsArrayPtr)
    {
...
FNakamaGroupList FNakamaGroupList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* GroupsArrayPtr;
  if (Json->TryGetArrayField(TEXT("groups"), GroupsArrayPtr))
  {
    for (const auto& Item : *GroupsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaGroupUserList FNakamaGroupUserList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* GroupUsersArrayPtr;
  if (Json->TryGetArrayField(TEXT("group_users"), GroupUsersArrayPtr))
  {
    for (const auto& Item : *GroupUsersArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaLeaderboardList FNakamaLeaderboardList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* LeaderboardsArrayPtr;
  if (Json->TryGetArrayField(TEXT("leaderboards"), LeaderboardsArrayPtr))
  {
    for (const auto& Item : *LeaderboardsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaLeaderboardRecordList FNakamaLeaderboardRecordList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* RecordsArrayPtr;
  if (Json->TryGetArrayField(TEXT("records"), RecordsArrayPtr))
  {
    for (const auto& Item : *RecordsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
  ...
  const TArray<TSharedPtr<FJsonValue>>* OwnerRecordsArrayPtr;
  if (Json->TryGetArrayField(TEXT("owner_records"), OwnerRecordsArrayPtr))
  {
    for (const auto& Item : *OwnerRecordsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaListLeaderboardRecordsRequest FNakamaListLeaderboardRecordsRequest::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* OwnerIdsArrayPtr;
  if (Json->TryGetArrayField(TEXT("owner_ids"), OwnerIdsArrayPtr))
  {
    for (const auto& Item : *OwnerIdsArrayPtr)
    {
...
FNakamaMatchList FNakamaMatchList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* MatchesArrayPtr;
  if (Json->TryGetArrayField(TEXT("matches"), MatchesArrayPtr))
  {
    for (const auto& Item : *MatchesArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaMatchmakerStats FNakamaMatchmakerStats::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* CompletionsArrayPtr;
  if (Json->TryGetArrayField(TEXT("completions"), CompletionsArrayPtr))
  {
    for (const auto& Item : *CompletionsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaNotificationList FNakamaNotificationList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* NotificationsArrayPtr;
  if (Json->TryGetArrayField(TEXT("notifications"), NotificationsArrayPtr))
  {
    for (const auto& Item : *NotificationsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaStorageObjectAcks FNakamaStorageObjectAcks::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* AcksArrayPtr;
  if (Json->TryGetArrayField(TEXT("acks"), AcksArrayPtr))
  {
    for (const auto& Item : *AcksArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaStorageObjects FNakamaStorageObjects::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  if (Json->TryGetArrayField(TEXT("objects"), ObjectsArrayPtr))
  {
    for (const auto& Item : *ObjectsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaTournamentList FNakamaTournamentList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* TournamentsArrayPtr;
  if (Json->TryGetArrayField(TEXT("tournaments"), TournamentsArrayPtr))
  {
    for (const auto& Item : *TournamentsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaUserGroupList FNakamaUserGroupList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* UserGroupsArrayPtr;
  if (Json->TryGetArrayField(TEXT("user_groups"), UserGroupsArrayPtr))
  {
    for (const auto& Item : *UserGroupsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaUsers FNakamaUsers::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* UsersArrayPtr;
  if (Json->TryGetArrayField(TEXT("users"), UsersArrayPtr))
  {
    for (const auto& Item : *UsersArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaValidatePurchaseResponse FNakamaValidatePurchaseResponse::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* ValidatedPurchasesArrayPtr;
  if (Json->TryGetArrayField(TEXT("validated_purchases"), ValidatedPurchasesArrayPtr))
  {
    for (const auto& Item : *ValidatedPurchasesArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaSubscriptionList FNakamaSubscriptionList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* ValidatedSubscriptionsArrayPtr;
  if (Json->TryGetArrayField(TEXT("validated_subscriptions"), ValidatedSubscriptionsArrayPtr))
  {
    for (const auto& Item : *ValidatedSubscriptionsArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
...
FNakamaPartyList FNakamaPartyList::FromJson(const TSharedPtr<FJsonObject>& Json)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* PartiesArrayPtr;
  if (Json->TryGetArrayField(TEXT("parties"), PartiesArrayPtr))
  {
    for (const auto& Item : *PartiesArrayPtr)
    {
      const TSharedPtr<FJsonObject>* ItemObj = nullptr;
      if (Item->TryGetObject(ItemObj) && ItemObj)
      {
