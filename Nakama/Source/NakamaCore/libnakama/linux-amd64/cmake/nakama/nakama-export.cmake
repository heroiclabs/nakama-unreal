...
set_target_properties(nakama-sdk PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "\$<\$<STREQUAL:\$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:/mnt/d/heroic/src/nakama-cpp/build/linux-amd64/libcxx/x64-linux-release/lib/libc++abi.a>;nakama-sdk-interface;Threads::Threads"
)
...
set_target_properties(nakama-api-proto PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<\$<STREQUAL:\$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:/mnt/d/heroic/src/nakama-cpp/build/linux-amd64/libcxx/x64-linux-release/lib/libc++abi.a>;\$<LINK_ONLY:protobuf::libprotobuf>"
)
